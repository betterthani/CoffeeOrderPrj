    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/portfolio/coffee-cup.png" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">5 Trillion Coffee</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">in-house coffee</p>
            </div>
        </header>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Please Login</h2>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">5조 커피서비스 페이지 입니다. 여러분은 이제 손쉽게 커피를 주문하고 기다림없이 바로 가져갈 수 있습니다! 새로운 서비스를 기대해주세요</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">This is the Article 5 coffee service page. You can now easily order your coffee and get it right away without waiting! Please look forward to our new service</p></div>
                </div>
